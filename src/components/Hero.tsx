...
import { easeOut, easeIn, motion, } from "motion/react"
        ...
        <div className='h-full w-full'>
            ...
            <div className='relative'>
                ...
                >
                    <motion.button
                        variants={child}
                        className='bg-gradient-to-b cursor-pointer text-sm h-9 font-normal hover:scale-[1.1] transition duration-200 from-[#CF94FF] to-[#6E12B8]  px-4 rounded-lg text-white shadow-button'
                    >
                        Get Started
                    </motion.button>
                    ...
                    <motion.button
                        variants={child}
                        className='flex cursor-pointer items-center justify-center  h-9 text-sm hover:scale-[1.1] transition duration-200 border-neutral-800 text-white  px-4 border rounded-lg bg-white/5'
                    >
                        <span> Learn More</span>
                        <ChevronRight className='size-5 pl-1' />
                    </motion.button>
                </motion.div>
            </div>
        </div>
...
function Pill() {
    return <motion.div
        ...
        className='px-1 py-1 flex justify-between gap-1 items-center border-neutral-800 border  text-xs  rounded-lg mt-24 w-fit mx-auto text-white '>
